...
model_tmp = LogisticRegressionCV(solver='saga', cv=5, scoring='f1', penalty='elasticnet', Cs=10, l1_ratios=l1_ratios)
model_tmp = model_tmp.fit(X_train, y)

best_C = model_tmp.C_.item()
best_l1_ratio = model_tmp.l1_ratio_.item()

model = LogisticRegression(solver='saga', penalty='elasticnet', C=best_C, l1_ratio=best_l1_ratio)
